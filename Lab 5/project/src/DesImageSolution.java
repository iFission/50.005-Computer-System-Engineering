...
public class DesImageSolution {
    public static void main(String[] args) throws Exception {
        ...
        BufferedImage img = ImageIO.read(new File("src/triangle.bmp"));
...
// TODO: convert the encrypted byte[] back into int[] and write to outImage (use setRGB)
            IntBuffer intBuf =
                    ByteBuffer.wrap(encrypted_each_width_pixel)
            ...
            for (int idy = 0; idy < image_length; idy++) {
                outImage.setRGB(idx, idy, array[idy]);
...
//write outImage into file
        ImageIO.write(outImage, "BMP", new File("Entriangle_CBC.bmp"));
    }
}